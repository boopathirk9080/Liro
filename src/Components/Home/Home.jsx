    ...
    return (
        <section class="pt-4 overflow-hidden bg-gray-50 md:pt-0 sm:pt-8 2xl:pt-8  "> {/* Reduced top padding */}
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid items-center grid-cols-1 md:grid-cols-2">
                    <div className=' ml-10  '>
                        <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Get join with Liro </h2>
                        <h2 class="text-3xl mt-2 font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Studios</h2>
                        {/* <h2 className="highlights">{text}<Cursor cursorStyle="|" /></h2> Added the 'highlights' class */}
                        <br></br>
                        <h2 className="text-3xl mt-4 font-bold subheading"><span class="highlights">{text}<Cursor cursorStyle="|" /></span></h2>
                        <p class="max-w-lg mt-4 text-xl  md:text-[24px] lg:text-[20px] leading-relaxed text-gray-600 md:mt-8">Welcome to Liro Studios, where creativity seamlessly meets innovation. As a premier design studio, we take pride in our ability to transform visions into captivating visual experiences.</p>
