...
//                     <h2 class="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl"><span class="highlights">WHAT CLIENTS SAY</span></h2>
//                     <br></br>
//                     <h3 class="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">Testimonials</h3>
...
//                                 <p class="text-lg text-black">As a videographer based in California, collaborating with LIRO Studios in India has been an absolute game-changer for my post-production needs. Their video editing and VFX services are second to none. The team’s expertise in transforming raw footage into visually captivating stories is truly impressive. They not only met but exceeded my expectations with their attention to detail, creativity, and ability to bring my vision to life.

//                                     Communication was seamless despite the distance, and their turnaround time was incredibly efficient. LIRO Studios is a true extension of our team at Murali Studio. I wholeheartedly recommend them to anyone looking for top-tier editing and visual effects work."
//                                 </p>
//                             </blockquote>
//                             <p class="text-base font-semibold tex-tblack mt-9">MURALI                    </p>
//                             <p class="mt-1 text-base text-gray-600">Murali Studio, California</p>
//                         </div>
//                     </div>
