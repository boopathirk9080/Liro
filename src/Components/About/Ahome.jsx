                    ...
                    <div class=" grid grid-cols-1  items-center md:grid-cols-2">
                        <div className=' ml-10  '>
                            ...
                            <p className="max-w-lg mt-4 text-xl text-justify  md:text-[24px] lg:text-[20px] leading-relaxed text-gray-600 md:mt-1rem">
                                ...
                                At LIRO Studios, we turn ideas into digital success. Our mission is to help businesses thrive in the digital age, offering services that boost growth, strengthen brands, and streamline operations. Whether you're a startup or an established company, LIRO Studios is here to drive your innovation and success.
                            </p>
