...
const SuccessStoryCard = () => {
    return (
        <div className='sm:h-743px] lg:h-1743px]  ' style={{  position: 'relative' }}>
            ...
            <div className="flex relative  lg:w-[598px] sm:w-[650px] lg:h-[485px] w-full h-auto lg:bottom-[598px] lg:left-[300px] mx-auto">
                {/* Image */}
                <img
            ...
            <div className='flex  sm:l-[100px]'  style={{ width: 599, height: 433, left: 152, top: 145, position: 'absolute' }}>
