            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8  max-w-7xl">
                ...
                <div className="flex flex-wrap items-center md:pl-5 md:pr-5 justify-between">
                    ...
                    <ul className="flex items-center space-x-3 md:order-3">
                        ...
                        <li>
                            <Link href="https://wa.me/91877879647?text=what%20you%20want"
                                target="_blank" className="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-16 h-16 focus:bg-blue-600 hover:bg-blue-600 hover:border-blue-600 focus:border-blue-600">
